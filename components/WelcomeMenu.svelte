    ...
    <div class="container px-4 mx-auto">
      <div class="flex justify-between items-center">
        ...
        <ul class="hidden lg:flex items-center w-auto space-x-12">
          <li><a class="text-sm text-gray-500 hover:text-gray-700" href="/#/login">Log in</a></li>
          <li><a class="block px-6 py-3 text-sm text-gray-500 hover:text-gray-700 font-bold border border-gray-100 hover:border-gray-200 rounded" href="/#/signup">Sign up</a></li>
        </ul>
      </div>
    </div>
