<section class="py-0"><div class="p-4 bg-gray-50 rounded-lg">
    <div class="flex flex-wrap items-center -mx-4">
        <div class="w-full md:w-1/2 px-4">
            <div class="max-w-md lg:ml-auto mb-5 lg:mb-0">
                <h3 class="mb-1 text-2xl font-bold font-heading">Got a Joining link?</h3>
            </div>
        </div>
        <div class="w-full md:w-1/2 px-4">
            <form action="#">
